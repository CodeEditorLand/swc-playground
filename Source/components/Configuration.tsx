		...
		<Flex direction="column">
			...
			<Flex
				...
				<VStack spacing="2">
					...
					<FormControl
						isDisabled={parsedSwcConfig.env?.targets != null}>
					...
					<FormControl>
						<FormLabel htmlFor="swc-source-type">
							Source Type
						</FormLabel>
						<Select
							id="swc-source-type"
						...
						<>
							...
							<FormControl display="flex" alignItems="center">
								<Switch
									id="swc-env-bugfixes"
									isChecked={
										parsedSwcConfig.env?.bugfixes == true
									}
									onChange={handleToggleEnvBugfixes}
								/>
								<FormLabel
									htmlFor="swc-env-bugfixes"
									ml="2"
									mb="0">
									Bugfixes
								</FormLabel>
					...
					<FormControl display="flex" alignItems="center">
						<Switch
							...
							onChange={(event) =>
								props.onStripTypesChange(event.target.checked)
							}
